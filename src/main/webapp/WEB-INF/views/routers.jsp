    ...
    <div class="before-footer">
        ...
        <div class="panel panel-default">
            <div class="panel-heading text-center">
                <h4>Routers statistics</h4>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="/user" method="POST" role="form" id="form">
                    <div class="form-group">
                        <div for="name" class="col-xs-4 test-right"><strong>Total routers num:</strong></div>
                        <div class="col-xs-7">
                            ${routersNum}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4 test-right"><strong>Router with max connections:</strong></div>
                        <div class="col-xs-7">
                            ${maxConnectionRouter["Name"]}, ${maxConnectionRouter["connections"]} connections
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4 test-right"><strong>Inactive routers:</strong></div>
                        <div class="col-xs-7">
                            ${inactiveRoutersNum}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4 test-right"><strong>Average connections per router:</strong></div>
                        <div class="col-xs-7">
                            ${averageConnectionsPerRouter}
                        </div>
                    </div>
                </form>
            </div>
